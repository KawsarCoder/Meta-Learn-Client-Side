      ...
      {categories.length ? (
        <>
          <div className=" grid lg:grid-cols-12 md:grid-cols-12 gap-5">
            <div className="text-center px-2 rounded-br-md py-10 font-bold bg-gray-50 lg:col-span-2 md:col-span-3">
            ...
            <div className="my-12 lg:mx-10 lg:col-span-10 md:col-span-9">
